...
import com.apollographql.execution.tracing.ApolloTracingInstrumentation
import com.apollographql.execution.tracing.ApolloTracingOperationContext
import com.apollographql.execution.tracing.Trace
...
class TracingTest {
  private fun schema(): ExecutableSchema {
    ...
    return ExecutableSchema.Builder()
      ...
      .addInstrumentation(ApolloTracingInstrumentation())
      .build()
  }

  @Test
  fun testTracing() {
    val context = ApolloTracingOperationContext()
    runBlocking {
